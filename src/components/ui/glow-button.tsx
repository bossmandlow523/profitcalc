...
export function GlowButton({
  ...
  return (
    <button
      ...
      className={cn(
        "w-full h-10 !px-5 text-sm rounded-md border flex items-center justify-between relative transition-all overflow-hidden bg-gradient-to-t border-r-0 duration-300 whitespace-nowrap group",
        "from-background to-muted text-foreground hover:text-foreground hover:font-semibold border-border hover:border-[var(--glow-color)] hover:shadow-[0_0_15px_var(--glow-color-via)]",
