...
export interface ContainerTextFlipProps {
  ...
  /** Array of custom colors for each word (optional) */
  wordColors?: string[];
}
...
export function ContainerTextFlip({
  ...
  return (
    ...
    >
      ...
      >
        <motion.div className="inline-block" style={wordColors && wordColors[currentWordIndex] ? { color: wordColors[currentWordIndex] } : undefined}>
          {words[currentWordIndex].split("").map((letter, index) => (
            <motion.span
              ...
              style={wordColors && wordColors[currentWordIndex] ? { color: wordColors[currentWordIndex] } : undefined}
            >
              {letter}
            </motion.span>
          ))}
